"""Evaluate AAPL v3 top configs (forward volume) on train+test."""
...
# AAPL det params: atr=2.0, close=False, mda=6.0, red=0.8, lb=126, comp=0.85, VC=True
AAPL_DET_BASE = {"atr_mult": 2.0, "use_close_only": False, "max_depth_atr": 6.0,
...
CONFIGS = [
    {"name": "FWD#1 w3_t1.2_f5 tr=3.0 be=1.0 sl=3%",
     "det": {**AAPL_DET_BASE,
    ...
    {"name": "FWD#2 w3_t1.2_f3 tr=3.0 be=1.0 sl=3%",
     "det": {**AAPL_DET_BASE,
             "vol_filter": {"window": 3, "threshold": 1.2, "forward": 3}},
     "exit": {"trailing_atr_multiplier": 3.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 1.0, "max_stop_loss_pct": 0.03}},

    {"name": "FWD#3 w1_t1.2_f5 tr=3.0 be=1.0 sl=3%",
     "det": {**AAPL_DET_BASE,
             "vol_filter": {"window": 1, "threshold": 1.2, "forward": 5}},
     "exit": {"trailing_atr_multiplier": 3.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 1.0, "max_stop_loss_pct": 0.03}},

    {"name": "Baseline no_filter tr=3.0 be=2.0 sl=3%",
     "det": {**AAPL_DET_BASE,
             "vol_filter": "no_filter"},
     "exit": {"trailing_atr_multiplier": 3.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 2.0, "max_stop_loss_pct": 0.03}},

    {"name": "Baseline no_filter tr=3.0 be=1.0 sl=3% (same exit as fwd)",
     "det": {**AAPL_DET_BASE,
             "vol_filter": "no_filter"},
     "exit": {"trailing_atr_multiplier": 3.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 1.0, "max_stop_loss_pct": 0.03}},
...
if __name__ == "__main__":
    ...
    print(f"{'='*70}")
    print(f"  AAPL — Evaluacion Train + Test (v3 forward volume)")
    print(f"{'='*70}")
