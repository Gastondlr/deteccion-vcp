"""Evaluate AMZN v3 top configs (forward volume) on train+test."""
...
# AMZN fwd top det: atr=3.0, close=False, mda=None, red=0.6, lb=126, tol=0.15, mdp=0.3, alt=0.01, comp=0.9, VC=True
AMZN_DET_FWD = {"atr_mult": 3.0, "use_close_only": False, "max_depth_atr": None,
...
# AMZN no_filter top det: atr=2.0, close=True, mda=8, red=0.8, lb=126, tol=0.1, mdp=0.3, alt=0.03, comp=0.95, VC=False
AMZN_DET_NF = {"atr_mult": 2.0, "use_close_only": True, "max_depth_atr": 8.0,
...
CONFIGS = [
    {"name": "FWD#1 w3_t1.2_f3 tr=2.0 be=1.5 sl=3% VC",
     "det": {**AMZN_DET_FWD,
    ...
    {"name": "FWD#2 w3_t1.2_f3 tr=2.5 tg=3R be=1.5 sl=3% VC",
     "det": {**AMZN_DET_FWD,
             "vol_filter": {"window": 3, "threshold": 1.2, "forward": 3}},
     "exit": {"trailing_atr_multiplier": 2.5, "target_r_multiple": 3.0, "early_exit_days": None,
              "breakeven_r_multiple": 1.5, "max_stop_loss_pct": 0.03}},

    {"name": "Baseline no_filter tr=2.0 be=1.5 sl=3% (best NF det)",
     "det": {**AMZN_DET_NF,
             "vol_filter": "no_filter"},
     "exit": {"trailing_atr_multiplier": 2.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 1.5, "max_stop_loss_pct": 0.03}},

    {"name": "Baseline no_filter tr=2.0 be=1.5 sl=3% (same det as fwd)",
     "det": {**AMZN_DET_FWD,
             "vol_filter": "no_filter"},
     "exit": {"trailing_atr_multiplier": 2.0, "target_r_multiple": None, "early_exit_days": None,
              "breakeven_r_multiple": 1.5, "max_stop_loss_pct": 0.03}},
...
if __name__ == "__main__":
    ...
    print(f"{'='*70}")
    print(f"  AMZN — Evaluacion Train + Test (v3 forward volume)")
    print(f"{'='*70}")
