"""Evaluate GOOGL v3 top configs (forward volume) on train+test."""
...
CONFIGS = [
    {"name": "COMP#1 v3 tr=2.5 tg=None sl=7% w3_t1.2_f3",
    ...
    {"name": "COMP#2 v3 tr=2.5 tg=None sl=7% w1_t1.2_f3",
     "det": {"atr_mult": 2.0, "use_close_only": True, "max_depth_atr": 8, "min_total_reduction": 0.80,
             "lookback_bars": 126, "compression_threshold": 0.95, "tolerance": 0.10, "max_depth_pct": 0.25,
             "ascending_lows_tolerance": 0.08, "volume_contraction": None,
    ...
    {"name": "COMP#3 v3 tr=2.5 tg=3R sl=5% w1_t1.2_f3 VC",
     "det": {"atr_mult": 2.0, "use_close_only": True, "max_depth_atr": 8, "min_total_reduction": 0.80,
    ...
    {"name": "v2 COMP#1 tr=2.5 tg=None sl=7% w3_t1.2 (baseline)",
     "det": {"atr_mult": 2.0, "use_close_only": True, "max_depth_atr": 8, "min_total_reduction": 0.80,
             "lookback_bars": 126, "compression_threshold": 0.95, "tolerance": 0.10, "max_depth_pct": 0.25,
             "ascending_lows_tolerance": 0.08, "volume_contraction": None,
...
if __name__ == "__main__":
    ...
    print(f"{'='*70}")
    print(f"  GOOGL — Evaluacion Train + Test (v3 forward volume)")
    print(f"{'='*70}")
